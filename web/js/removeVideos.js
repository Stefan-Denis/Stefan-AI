        ...
        if (localStorage.getItem('currentTab') !== 'removeVideo') {
            ...
            try {
                ...
                videos.forEach((video) => {
                    ...
                    viewButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                        // handle view button click for this video
                        const response = yield fetch(`/videos/view`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                setTimeout(() => {
                    var _a;
                    (_a = document.getElementById('main-stylesheet')) === null || _a === void 0 ? void 0 : _a.setAttribute('href', 'css/style-nogrid.css');
                }, 3);
            }
            catch (error) {
                console.error(error);
